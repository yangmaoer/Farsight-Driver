...
int volume[] = {0, 1912, 1730, 1517, 1432, 1275, 1136, 1012, 965, 851, 758, 715, 637, 568, 506};
int t[] = {6,6,8,7,6,5,6,3,0,6,5,6,6,8,7,8,6,7,8,0,8,9,10,10,10,10,9};
...
//	iowrite32(data & ~(0xf) | 0x2, pwm.gpd0con)	;
	...
	else
	{
		...
		data = ioread32(pwm.TCMPB0);
		iowrite32(data >> 1, pwm.TCMPB0);
		data = ioread32(pwm.TCON);
		iowrite32(data | 1 << 1 , pwm.TCON);
		data = ioread32(pwm.TCON);
